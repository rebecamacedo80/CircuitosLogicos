...
-- y	=>  Location: PIN_R6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 12mA
-- b	=>  Location: PIN_G7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- a	=>  Location: PIN_W5,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- c	=>  Location: PIN_AA4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
\y~0\ : stratixii_lcell_comb
-- Equation(s):
-- \y~0_combout\ = ( \c~combout\ & ( !\b~combout\ & ( \a~combout\ ) ) ) # ( !\c~combout\ & ( !\b~combout\ ) )
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_a~combout\,
	datae => \ALT_INV_c~combout\,
