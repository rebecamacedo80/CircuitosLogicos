...
-- p	=>  Location: PIN_24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- g	=>  Location: PIN_28,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- s[0]	=>  Location: PIN_8,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- s[1]	=>  Location: PIN_9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- s[2]	=>  Location: PIN_27,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \carry|pg~0_combout\ = (\b~combout\(1) & (!\a~combout\(1) & (\b~combout\(2) $ (\a~combout\(2))))) # (!\b~combout\(1) & (\a~combout\(1) & (\b~combout\(2) $ (\a~combout\(2)))))
...
-- Equation(s):
-- \carry|pg~1_combout\ = (\carry|pg~0_combout\ & (\somador3|p~0_combout\ & (\b~combout\(0) $ (\a~combout\(0)))))
...
-- Equation(s):
-- \carry|c~1_combout\ = (\b~combout\(1) & (!\a~combout\(1) & ((!\a~combout\(0)) # (!\b~combout\(0))))) # (!\b~combout\(1) & (((!\a~combout\(1)) # (!\a~combout\(0))) # (!\b~combout\(0))))
...
-- Equation(s):
-- \somador1|p~0_combout\ = \b~combout\(1) $ (\a~combout\(1))
...
-- Equation(s):
-- \carry|c~2_combout\ = (\cin~combout\ & (\a~combout\(0) $ (\b~combout\(0))))
...
-- Equation(s):
-- \carry|c~3_combout\ = (\b~combout\(2) & ((\a~combout\(2)) # ((\b~combout\(1) & \a~combout\(1))))) # (!\b~combout\(2) & (\b~combout\(1) & (\a~combout\(1) & \a~combout\(2))))
...
-- Equation(s):
-- \somador3|s~combout\ = \somador3|p~0_combout\ $ (((\carry|c~3_combout\) # ((\carry|c~0_combout\ & \carry|pg~0_combout\))))
